...
\newcommand{\citeform[1]}{\textcolor{blue}{#1}}% las citas en el texto salen de color azul
...
\begin{enumerate}
\item Producción(formato csv) \newline
https://www.datos.gov.co/Agricultura-y-Desarrollo-Rural/Cadena-Productiva-Ma-z-Area-Producci-n-Y-Rendimien/d968-yfb5

\item Imágenes de temperatura (formato tiff, imagen georeferenciada) \newline
https://developers.google.com/earth-engine/datasets/catalog/MODIS\_006\_MOD11A1

\item Polígonos de veredas que contienen municipios (formato shp) \newline
...
En caso de no disponer de los datos mediante bases de datos en abierto necesitaríamos de: 
...
- Análisis químico del suelo para determinar las necesidades nutricionales del mismo, y elegir un abono u otro para la siembra. 
...
\section{Plan de preservación de los datos}
...
El último repositorio s

El repositorio en la plataforma github.com servirá para obtener los datos rápidamente. Además, la comunidad puede contribuir en mantener y contrastar los datos con otras fuentes. 
