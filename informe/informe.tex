...
\begin{figure}[H]
    \centering
	\includegraphics[width=0.6\textwidth]{figures/cosecha.png} % 10x10 t=3 dt=0.001 n=10
...
%\includegraphics[width=1\textwidth]{header.jpg}\par\vspace{1cm}
    \centering
	\includegraphics[width=0.6\textwidth]{figures/rendimiento.png} % 10x10 t=3 dt=0.001 n=10
